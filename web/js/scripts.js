    ...
    .then((data) => {
      ...
      for (let i = 0; i < packageList.length; i++) {
        ...
        packageHtml += `<div class="tour-package-wrapper">
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    <div class="flip-card-front">
                        <div id="lazyLoadDiv" class="tour-package d-flex flex-column justify-content-between px-2 py-3" style="background-image: url('${package["backgroundImage"]}');" onclick="onclickPackage('${package["id"]}', '${package["pricePerPersonVan"]}', '${package["pricePerPersonSuv"]}', '${package["pricePerPersonVan"] * 7}', '${package["pricePerPersonVan"] * 4}')" role="button">
                            <div class="tour-card-body blur-bg px-2 py-3" style="text-align: center;">
                                <div class="tour-card-body-price text-white fw-bold" style="font-size: 35px;">$${package["pricePerPersonVan"]} Per Person</div>
                            </div>
                            <div class="tour-card-footer text-white py-3">
                                <div class="blur-bg duration-wrapper">
                                    <i class="fas fa-clock" style="font-size: 20px;"></i>
                                    <div class="duraiton-text ml-2" style="font-size: 14px;">${package["durationInHours"]}hrs</div>
                                </div>
                                <div class="blur-bg timslot-wrapper">${package["tourTimes"]}</div>
                            </div>
                        </div>
                    </div>
            ...
            <a id="bookPackageThree" href="tour.html" role="button" onclick="onclickPackage('${package["id"]}', '${package["pricePerPersonVan"]}', '${package["pricePerPersonSuv"]}', '${package["pricePerPersonVan"] * 7}', '${package["pricePerPersonVan"] * 4}')" class="btn btn-lg btn-dark text-regular w-100 rounded-pill  px-3 py-3">Book Now</a>
